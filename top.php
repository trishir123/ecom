...
$cat_res1=mysqli_query($con,"select * from categories where parent_cat='Men' order by categories asc");
$cat_arr1=array();
while($row1=mysqli_fetch_assoc($cat_res1)){
	$cat_arr1[]=$row1;	
}
$cat_res2=mysqli_query($con,"select * from categories where parent_cat='Women' order by categories asc");
$cat_arr2=array();
                            ...
                            <div class="col-md-7 col-lg-7 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="#">MEN PRODUCT</a>
                                            <ul class="dropdown">
                                                <?php
                                        ...
                                        <li class="drop"><a href="#">WOMEN PRODUCT</a>
                                            <ul class="dropdown">
                                                <?php
